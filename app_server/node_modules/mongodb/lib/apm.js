...
// Get prototypes
var AggregationCursor = require('mongodb/lib/aggregation_cursor'),
  CommandCursor = require('mongodb/lib/command_cursor'),
  OrderedBulkOperation = require('mongodb/lib/bulk/ordered').OrderedBulkOperation,
  UnorderedBulkOperation = require('mongodb/lib/bulk/unordered').UnorderedBulkOperation,
  GridStore = require('mongodb/lib/gridfs/grid_store'),
...
var Instrumentation = function(core, options, callback) {
  ...
  methods = ['execute'];
  var prototypes = [
    require('mongodb/lib/bulk/ordered').Bulk.prototype,
    require('mongodb/lib/bulk/unordered').Bulk.prototype
  ]
  ...
  prototypes = [
    require('mongodb/lib/cursor').prototype,
    require('mongodb/lib/command_cursor').prototype,
    require('mongodb/lib/aggregation_cursor').prototype
  ]
